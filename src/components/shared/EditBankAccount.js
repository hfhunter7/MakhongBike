...
import { checkNull } from "../../helpers/generalHelper";
...
class EditBankAccount extends Component {
    ...
    constructor( props ) {
        ...
        this.state = {
            ...
            zip_code: "",
            age: '',
            bank_account: this.props.bank.bank_name,
            value: this.props.bank.bank_type,
    ...
    handleSaveBank = () => {
        let data = {
            //"bankName": this.state.bank_account === undefined || this.state.bank_account === '' ? this.props.bank.bank_name : this.state.bank_account,
            "bankName": checkNull(this.state.bank_account,this.props.bank.bank_name),
            "holderName": checkNull(this.state.account_name,this.props.bank.bank_holder),
          //  "holderName": this.state.account_name === undefined || this.state.account_name === '' ? this.props.bank.bank_holder : this.state.account_name,
            "bankNumber": this.state.account_number === undefined || this.state.account_number === '' ? this.props.bank.bank_number : this.state.account_number,
            "bankType": this.state.account_type === undefined || this.state.account_type === '' ? this.props.bank.bank_type : this.state.account_type,
            "branch": this.state.branch === undefined || this.state.branch === '' ? this.props.bank.bank_branch : this.state.branch,
        };
        console.log(data)
        this.props.handleEditAccount(data);
                ...
                <Dialog
                    ...
                    <DialogContent>
                        ...
                        <TextField autoFocus
                                   ...
                                   defaultValue={this.props.bank.bank_number}
                                   id="account_number"
                                   name="account_number"
                        ...
                        <TextField margin="dense"
                                   ...
                                   defaultValue={this.props.bank.bank_holder}
                                   id="account_name"
                                   name="account_name"
                        ...
                        <TextField margin="dense"
                                   ...
                                   defaultValue={this.props.bank.bank_branch}
                                   id="branch"
                                   name="branch"
                    ...
                    <DialogActions>
                        ...
                        <Button raised onClick={this.handleSaveBank} color="primary">
                            EDIT BANK
                        </Button>
                    </DialogActions>
                </Dialog>
...
export default connect(mapStateToProps, null)(withStyles(styles)(EditBankAccount));