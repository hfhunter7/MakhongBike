...
class ConfirmDeleteReserve extends Component {
    DeleteReserve = () => {
        this.props.handleDeleteReserve(this.props.reserve_id);
            ...
            <ConfirmDialogContainer>
                <Dialog
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={this.DeleteReserve} color="primary" autoFocus>
...
ConfirmDeleteReserve.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter((ConfirmDeleteReserve)));