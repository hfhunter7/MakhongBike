            ...
            <NavBarFooterContainer>
                {
                    Object.keys(this.props.user).length === 0 ?
                        ...
                        :
                        <NavBarFooterRow>
                            <NavItem onClick={this.handleClick.bind(this, '/')} active={dashboard} first><NavIcon
                                active={dashboard} name="description"/></NavItem>
                            <NavItem onClick={this.handleClick.bind(this, '/courses')} active={courses}><NavIcon
                                active={courses} name="layers"/></NavItem>
                            <NavItem onClick={this.handleClick.bind(this, '/certificates')} active={cer}><NavIcon
                                active={cer} name="card_giftcard"/></NavItem>
                            <NavItem onClick={this.handleClick.bind(this, '/exams')} active={exam}><NavIcon
                                active={exam} name="help_outline"/></NavItem>
                            {/*{*/}
